...
define("forum/topic/events", [
    ...
    const events = {
        ...
        "posts.anon": togglePostAnon,
        "posts.unanon": togglePostAnon,
    ...
    function togglePostAnon(data) {
        ...
        const el = $(
            '[data-pid="' + data.post.pid + '"] [component="post/anon"]'
        ).filter(function (index, el) {
            return (
                parseInt($(el).closest("[data-pid]").attr("data-pid"), 10) ===
                parseInt(data.post.pid, 10)
        ...
        el.find('[component="post/anon/on"]').toggleClass(
            "hidden",
            !data.isAnon
        )
        el.find('[component="post/anon/off"]').toggleClass(
            "hidden",
            data.isAnon
        )
    }
